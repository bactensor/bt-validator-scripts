...
def main():
    ...
    remote_directory = '~/data-universe'
    ...
    time.sleep(3)
    sec = find_secret("data-universe", 13, 1300, 'dev1300')
    ...
    local_env_file = "subnets/Dataverse/.env"
    ...
    connection.put(local_env_file, remote='data-universe/.env')
    connection.put('subnets/Dataverse/install.sh', remote='data-universe/install.sh')
    connection.put('subnets/Dataverse/run_vali.sh', remote='data-universe/run_vali.sh')
