...
def main():
    ...
    time.sleep(3)
    sec = find_secret("NASChain", 31, 123, 'dev123')
    
    # Create .env file locally
    local_env_file = "subnets/NAS Chain/.env"
    ...
    connection.put(local_env_file, remote='NASChain/.env')
    connection.put('subnets/NAS Chain/install.sh', remote='NASChain/install.sh')
    connection.put('subnets/NAS Chain/run_vali.sh', remote='NASChain/run_vali.sh')
...
# python3 NASChain.py shane@37.27.180.98 "your server password" /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa
