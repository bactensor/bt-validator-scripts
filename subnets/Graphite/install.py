...
def main():
    ...
    time.sleep(3)
    sec = find_secret("graphite", 43, 65, 'dev65')
    
    # Create .env file locally
    local_env_file = "subnets/Graphite/.env"
    ...
    connection.put(local_env_file, remote='graphite/.env')
    connection.put('subnets/Graphite/install.sh', remote='graphite/install.sh')
    connection.put('subnets/Graphite/run_vali.sh', remote='graphite/run_vali.sh')
