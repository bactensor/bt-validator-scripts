...
def main():
    ...
    remote_directory = '~/MyShell-TTS-Subnet'
    ...
    time.sleep(3)
    sec = find_secret("MyShell-TTS-Subnet", 3, 31, 'dev31')
    
    # Create .env file locally
    local_env_file = "subnets/MyShell TTS/.env"
    ...
    connection.put(local_env_file, remote='MyShell-TTS-Subnet/.env')
    connection.put('subnets/MyShell TTS/install.sh', remote='MyShell-TTS-Subnet/install.sh')
    connection.put('subnets/MyShell TTS/run_vali.sh', remote='MyShell-TTS-Subnet/run_vali.sh')
...
# python3 MyShell-TTS-Subnet.py "your server password" shane@37.27.180.98 /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa
