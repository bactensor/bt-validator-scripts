...
def main():
    ...
    time.sleep(3)
    sec = find_secret("cortex.t", 18, 24, 'dev24')
    
    # Create .env file locally
    local_env_file = "subnets/Cortex.t/.env"
    ...
    connection.put(local_env_file, remote='cortex.t/.env')
    connection.put('subnets/Cortex.t/install.sh', remote='cortex.t/install.sh')
    connection.put('subnets/Cortex.t/run_vali.sh', remote='cortex.t/run_vali.sh')
