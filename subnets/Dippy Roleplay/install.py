...
def main():
    ...
    remote_directory = '~/dippy-bittensor-subnet'
    ...
    time.sleep(3)
    # sec = find_secret("dippy-bittensor-subnet", 11, 135, 'dev135')
    
    # Create .env file locally
    local_env_file = "subnets/Dippy Roleplay/.env"
    ...
    connection.put(local_env_file, remote='dippy-bittensor-subnet/.env')
    connection.put('subnets/Dippy Roleplay/install.sh', remote='dippy-bittensor-subnet/install.sh')
    connection.put('subnets/Dippy Roleplay/run_vali.sh', remote='dippy-bittensor-subnet/run_vali.sh')
...
# python3 dippy-bittensor-subnet.py "your server password" shane@37.27.180.98 /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa
