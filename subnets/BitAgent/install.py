...
def main():
    ...
    remote_directory = '~/bitagent_subnet'
    ...
    local_env_file = "subnets/BitAgent/.env"
    ...
    print(".env file made successfully")
    ...
    connection.put(local_env_file, remote='bitagent_subnet/.env')
    connection.put('subnets/BitAgent/install.sh', remote='bitagent_subnet/install.sh')
    connection.put('subnets/BitAgent/run_vali.sh', remote='bitagent_subnet/run_vali.sh')
