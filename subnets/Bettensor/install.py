...
def main():
    ...
    time.sleep(3)
    sec = find_secret("Bettensor", 30, 181, 'dev181')
    
    # Create .env file locally
    local_env_file = "subnets/Bettensor/.env"
    ...
    connection.put(local_env_file, remote='bettensor/.env')
    connection.put('subnets/Bettensor/install.sh', remote='bettensor/install.sh')
    connection.put('subnets/Bettensor/run_vali.sh', remote='bettensor/run_vali.sh')
