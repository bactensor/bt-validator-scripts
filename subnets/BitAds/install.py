...
def main():
    ...
    time.sleep(3)
    # sec = find_secret("BitAds.ai", 2, 118, 'dev118')
    
    # Create .env file locally
    local_env_file = "subnets/BitAds/.env"
    ...
    connection.put(local_env_file, remote='BitAds.ai/.env')
    connection.put('subnets/BitAds/install.sh', remote='BitAds.ai/install.sh')
    connection.put('subnets/BitAds/run_vali.sh', remote='BitAds.ai/run_vali.sh')
...
# python3 BitAds.ai.py "your server password" shane@37.27.180.98 /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa
