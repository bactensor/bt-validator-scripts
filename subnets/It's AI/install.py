...
def main():
    ...
    remote_directory = '~/llm-detection'
    ...
    time.sleep(3)
    # sec = find_secret("llm-detection", 32, 87, 'dev87')
    
    # Create .env file locally
    local_env_file = "subnets/It's AI/.env"
    ...
    connection.put(local_env_file, remote='llm-detection/.env')
    connection.put("subnets/It's AI/install.sh", remote='llm-detection/install.sh')
    connection.put("subnets/It's AI/run_vali.sh", remote='llm-detection/run_vali.sh')
