...
def main():
    ...
    time.sleep(3)
    sec = find_secret("openkaito", 5, 88, 'dev88')
    
    # Create .env file locally
    local_env_file = "subnets/Open Kaito/.env"
    ...
    connection.put(local_env_file, remote='openkaito/.env')
    connection.put('subnets/Open Kaito/install.sh', remote='openkaito/install.sh')
    connection.put('subnets/Open Kaito/run_vali.sh', remote='openkaito/run_vali.sh')
