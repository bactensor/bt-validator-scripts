...
def main():
    ...
    remote_directory = '~/tensor_alchemy'
    ...
    time.sleep(3)
    sec = find_secret("tensor_alchemy", 26, 25, 'dev25')
    
    # Create .env file locally
    local_env_file = "subnets/Tensor Alchemy/.env"
    ...
    connection.put(local_env_file, remote='TensorAlchemy/.env')
    connection.put('subnets/Tensor Alchemy/install.sh', remote='tensor_alchemy/install.sh')
    connection.put('subnets/Tensor Alchemy/run_vali.sh', remote='tensor_alchemy/run_vali.sh')
...
# python3 install.py shane@37.27.180.98 "Type your server password" /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa 
