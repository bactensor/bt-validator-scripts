...
def main():
    ...
    time.sleep(3)
    sec = find_secret("smart-scrape", 22, 2200, 'dev2200')
    
    # Create .env file locally
    local_env_file = "subnets/Meta Search/.env"
    ...
    connection.put(local_env_file, remote='smart-scrape/.env')
    connection.put('subnets/Meta Search/install.sh', remote='smart-scrape/install.sh')
    connection.put('subnets/Meta Search/run_vali.sh', remote='smart-scrape/run_vali.sh')
