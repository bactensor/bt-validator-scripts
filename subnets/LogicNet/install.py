...
def main():
    ...
    local_env_file = "subnets/LosicNet/.env"
    ...
    connection.put(local_env_file, remote='LosicNet/.env')
    connection.put('subnets/LosicNet/install.sh', remote='LosicNet/install.sh')
    connection.put('subnets/LosicNet/run_vali.sh', remote='LosicNet/run_vali.sh')
