...
def main():
    ...
    time.sleep(3)
    # sec = find_secret("sportstensor", 41, 172, 'dev172')
    
    # Create .env file locally
    local_env_file = "subnets/Sportstensor/.env"
    ...
    connection.put(local_env_file, remote='sportstensor/.env')
    connection.put('subnets/Sportstensor/install.sh', remote='sportstensor/install.sh')
    connection.put('subnets/Sportstensor/run_vali.sh', remote='sportstensor/run_vali.sh')
