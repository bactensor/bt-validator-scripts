...
def main():
    ...
    remote_directory = '~/score_predict'
    ...
    time.sleep(3)
    # sec = find_secret("score_predict", 44, 180, 'dev180')
    
    # Create .env file locally
    local_env_file = "subnets/Score Predict/.env"
    ...
    connection.put(local_env_file, remote='score_predict/.env')
    connection.put('subnets/Score Predict/install.sh', remote='score_predict/install.sh')
    connection.put('subnets/Score Predict/run_vali.sh', remote='score_predict/run_vali.sh')
