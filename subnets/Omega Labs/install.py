...
def main():
    ...
    remote_directory = '~/omegalabs-bittensor-subnet'
    ...
    time.sleep(3)
    # sec = find_secret("omegalabs-bittensor-subnet", 24, 96, 'dev96')
    
    # Create .env file locally
    local_env_file = "subnets/Omega Labs/.env"
    ...
    connection.put(local_env_file, remote='omegalabs-bittensor-subnet/.env')
    connection.put('subnets/Omega Labs/install.sh', remote='omegalabs-bittensor-subnet/install.sh')
    connection.put('subnets/Omega Labs/run_vali.sh', remote='omegalabs-bittensor-subnet/run_vali.sh')
...
# python3 install.py "your server password" shane@37.27.180.98 /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa 
