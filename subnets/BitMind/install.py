...
def main():
    ...
    time.sleep(3)
    # sec = find_secret("bitmind", 34, 168, 'dev168')
    
    # Create .env file locally
    local_env_file = "subnets/BitMind/.env"
    ...
    connection.put(local_env_file, remote='bitmind/.env')
    connection.put('subnets/BitMind/install.sh', remote='bitmind/install.sh')
    connection.put('subnets/BitMind/run_vali.sh', remote='bitmind/run_vali.sh')
