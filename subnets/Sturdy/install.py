...
def main():
    ...
    remote_directory = '~/sturdy-subnet'
    ...
    time.sleep(3)
    # sec = find_secret("sturdy-subnet", 10, 104, 'dev104')
    
    # Create .env file locally
    local_env_file = "subnets/Sturdy/.env"
    ...
    connection.put(local_env_file, remote='sturdy-subnet/.env')
    connection.put('subnets/Sturdy/install.sh', remote='sturdy-subnet/install.sh')
    connection.put('subnets/Sturdy/run_vali.sh', remote='sturdy-subnet/run_vali.sh')
...
# python3 sturdy-subnet.py "your server password" shane@37.27.180.98 /Users/mac/Downloads/project/wallet/wombo/hotkeys/JJa
