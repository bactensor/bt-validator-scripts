...
def main():
    ...
    time.sleep(3)
    sec = find_secret("Finetuning", 37, 179, 'dev179')    
    
    # Create .env file locally
    local_env_file = "subnets/Finetuning/.env"
    ...
    connection.put(local_env_file, remote='finetuning/.env')
    connection.put('subnets/Finetuning/install.sh', remote='finetuning/install.sh')
    connection.put('subnets/Finetuning/run_vali.sh', remote='finetuning/run_vali.sh')
