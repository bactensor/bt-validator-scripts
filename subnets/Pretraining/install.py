...
def main():
    ...
    local_env_file = "subnets/Pretraining/.env"
    ...
    connection.put(local_env_file, remote='pretraining/.env')
    connection.put('subnets/Pretraining/install.sh', remote='pretraining/install.sh')
    connection.put('subnets/Pretraining/run_vali.sh', remote='pretraining/run_vali.sh')
