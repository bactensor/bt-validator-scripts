...
def main():
    ...
    remote_directory = '~/proprietary-trading-network'
    ...
    time.sleep(3)
    sec = find_secret("proprietary-trading-network", 8, 116, 'dev116')
    local_env_file = "subnets/Proprietary Trading Network/.env"
    ...
    local_json_file = 'subnets/Proprietary Trading Network/api_keys.json'

    # Open the file in write mode and dump the JSON
    with open(local_json_file, 'w') as file:
        json.dump(sec, file, indent=2)
    ...
    connection.put(local_json_file, remote='proprietary-trading-network/secrets.json')
    connection.put(local_env_file, remote='proprietary-trading-network/.env')
    connection.put('subnets/Proprietary Trading Network/install.sh', remote='proprietary-trading-network/install.sh')
    connection.put('subnets/Proprietary Trading Network/run_vali.sh', remote='proprietary-trading-network/run_vali.sh')
