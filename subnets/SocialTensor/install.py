...
def main():
    ...
    time.sleep(3)
    # sec = find_secret("NicheImage", 23, 119, 'dev119')
    
    # Create .env file locally
    local_env_file = "subnets/SocialTensor/.env"
    ...
    connection.put(local_env_file, remote='NicheImage/.env')
    connection.put('subnets/SocialTensor/install.sh', remote='NicheImage/install.sh')
    connection.put('subnets/SocialTensor/run_vali.sh', remote='NicheImage/run_vali.sh')
